module MangaedenApi
  class Manga
    ...
    attr_accessor :aka, :aka_alias, :alias, :artist, :artist_kw, :author, :author_kw,
      :categories, :chapters_len, :chapters_info, :created, :description, :hits, :image,
      :language, :last_chapter_date, :random, :released, :startsWith, :status, :title,
      :title_kw, :type, :updatedKeywords, :manga_id
