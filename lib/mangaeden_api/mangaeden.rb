...
module MangaedenApi
  class Mangaeden
    ...
    # Where [manga.id] is the manga's id you can get with the Manga::list api call 
    ...
    def self.get_manga_info(manga_id)
      ...
      manga = MangaedenApi::Manga.new(manga_info, manga_id)
    ...
    def self.get_chapter_images(chapter_info)
      ...
      chapter = MangaedenApi::Chapter.new(images, chapter_info)
